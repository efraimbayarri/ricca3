...
$ricca3_sii_fitxers=array(
		...
		"nombd"     =>array("idalumne", "",      "cognomsinom", "grup", "idgrup", "dni", "SII_TipusDocumentIdentitat", "SII_Sexe", "SII_CodiMunicipiNaixement", "SII_CodiProvinciaNeixement", "SII_CodiPaisNeixement", "SII_CodiNacionalitat", "SII_CodiMunicipi", "codipostal", "SII_CodiPais", "SII_SituacioLaboral"),
		...
		"camp"      =>array("",         "",      "",            "",     "",       "",    "",                           "",         "",                          "",                           "",                      "",                     "",                 "",           "",              ""),
		"texte"     =>array("",         "",      "",            "",     "",       "",    "",                           "",         "",                          "",                           "",                      "",                     "",                 "",           "",              ""),
		"nomeslect" =>array(false,      true,    true,          true,   false,    true,  true,                         true,       true,                        true,                         true,                    true,                   true,               true,         true,            true),
