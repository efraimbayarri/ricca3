...
$ricca3_alumcol=array(
	"tipus"     =>array("bd",    "bd",        "bd",        "bd",                "bd",                           "bd",                "bd",                   "bd",             "bd",                  "bd",                  "bd",    "bd",                 "bd",             "bd",                "bd",         "bd",      "bd",           "bd",              "bd",                "bd",             "bd",               "bd",              "bd"),
	"nombd"     =>array("nom",   "cognom1",   "cognom2",   "dni",               "SII_TipusDocumentIdentitat",   "datanai",           "SII_Sexe",             "paisnai",        "llocnai",             "provnai",             "email", "residenciahabitual", "ciutathabitual", "provinciahabitual", "codipostal", "telefon", "telefonfixe",  "datainscripcio",  "estudisrealitzats", "centreea",       "poblacioea",       "llenguafamiliar", "abonament"),
	"visual"    =>array("Nom",   "1er Cognom","2on Cognom","DNI/NIE/passaport", "Tipus-> DNI:A NIE:B Passa.:C", "Data de naixement", "Sexe-> Home:H Dona:D", "País naixament", "Localitat naixement", "Província naixement", "email", "Domicili",           "Ciutat",         "Província",         "C.P.",       "Telefon", "Telefon fixe", "Inscripció",      "Estudis",           "Centre estudis", "Població estudis", "Contactat",       "Abonament"),
	"nomform"   =>array("Nom",   "Cog1",      "Cog2",      "DNI",               "TipusDNI",                     "FN",                "Sexe",                 "PaisN",          "LocN",                "ProvN",               "Email", "Resi",               "Ciutat",         "Prov",              "CP",         "Telf",    "Telf2",        "Insc",            "EstudA",            "CentEA",         "PobEA",            "Contactat",       "Abono"),
	"nomes-az"  =>array(false,   false,       false,       false,               true,                           false,               true,                   true,             false,                 true,                  false,   false,                false,            true,                false,        false,     false,          false,             false,               false,            false,              false,             false),
	"obliga"    =>array(true,    true,        false,	   true,                false,                          true,                true,                   true,             true,                  false,                 false,   false,                false,            false,               false,        false,     false,          false,             false,               false,            false,              false,             false),
	"data"      =>array(false,   false,       false,       false,               false,                          true,                false,                  false,            false,                 false,                 false,   false,                false,            false,               false,        false,     false,          true,              false,               false,            false,              false,             false),
	"nomeslect" =>array(false,   false,       false,       false,               true,                           false,               false,                  false,            false,                 false,                 false,   false,                false,            false,               false,        false,     false,          true,              false,               false,            false,              false,             true)
);
...
$ricca3_butons_avaluacions=array(
	"imatge" =>array("actes",        "notes",        "observacions", "calcularnotaf",        "veurecalculs",       "notesuf",        "certifaval",    "certifcurs1",        "certiffinal",        "buid",               "buid",               "buid"),
...
/**   */
#############################################################################################
$ricca3_butons_notaalumne=array(
"imatge" =>array("avaluacions",        "notaalumne",        "buid",               "buid",               "buid",               "buid"),
"enllac" =>array("ricca3-avaluacions", "ricca3-notaalumne", "ricca3-avaluacions", "ricca3-avaluacions", "ricca3-avaluacions", "ricca3-avaluacions"),
"id"     =>array(false,                false,               false,                false,                false,                false),
"texte"  =>array("",                   "" ,                 "",                   "",                   "",                   "")
);
