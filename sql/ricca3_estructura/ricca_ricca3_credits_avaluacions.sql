...
CREATE TABLE `ricca3_credits_avaluacions` (
  ...
  `convext1` int(11) DEFAULT '1',
  `convext2` int(11) DEFAULT '1',
  ...
  KEY `repe` (`repe`),
  KEY `convord` (`convord`),
  KEY `convext1` (`convext1`),
  KEY `convext2` (`convext2`),
  ...
  CONSTRAINT `ricca3_credits_avaluacions_ibfk_4` FOREIGN KEY (`convord`) REFERENCES `ricca3_any` (`idany`),
  CONSTRAINT `ricca3_credits_avaluacions_ibfk_5` FOREIGN KEY (`convext1`) REFERENCES `ricca3_any` (`idany`),
  CONSTRAINT `ricca3_credits_avaluacions_ibfk_6` FOREIGN KEY (`convext2`) REFERENCES `ricca3_any` (`idany`)
) ENGINE=InnoDB AUTO_INCREMENT=10360 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
