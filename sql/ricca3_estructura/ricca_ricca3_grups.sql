...
DROP TABLE IF EXISTS `ricca3_grups`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ricca3_grups` (
  ...
  KEY `idcurs` (`idcurs`),
  CONSTRAINT `ricca3_grups_ibfk_1` FOREIGN KEY (`idcurs`) REFERENCES `ricca3_cursos` (`idcurs`),
  CONSTRAINT `ricca3_grups_ibfk_2` FOREIGN KEY (`idespecialitat`) REFERENCES `ricca3_especialitats` (`idespecialitat`)
